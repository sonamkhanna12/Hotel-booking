...
const PropertyList = () => {
  const propertuList = [
    ...
    {type: "Cabins",
      quantity: 117,
      photo: "https://cf.bstatic.com/static/img/theme-index/carousel_320x240/card-image-chalet_300/8ee014fcc493cb3334e25893a1dee8c6d36ed0ba.jpg"
    },
  ]
  return (
    <div className="pList">
      {propertuList.map((e, i)=>
        <div key={i} className="pListItem">
          <img src={e.photo} alt="" className="pListImg"/>
          <div className="pListTitles">
            <h1>{e.type}</h1>
            <h2>{e.quantity} hotels</h2>
          </div>
        </div>
      )}
    </div>
